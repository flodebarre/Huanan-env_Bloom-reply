...
\begin{tabular}{ll}
a) & b) \\[-1.275em]
\hspace{1ex} \includegraphics[width=0.485\textwidth]{{../figs/correlations_SARS-CoV-2_all_ACC1.Jan01}.pdf}
&
\hspace{1ex} \includegraphics[width=0.485\textwidth]{{../figs/correlations_SARS-CoV-2_all_ACC1.Jan12}.pdf}
\end{tabular}
\vspace{-1cm}
